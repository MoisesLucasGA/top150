...
// Adapting the code from 207-courseSchedule
function canFinish2(numCourses: number, prerequisites: number[][]): number[] {
...
const numCourses = 4, prerequisites = [[1, 0], [2, 3], [3, 1],]
